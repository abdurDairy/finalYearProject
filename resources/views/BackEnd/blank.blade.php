            ...
            <ul class="mobile-menu-wrapper border-top border-theme-29 dark-border-dark-3 py-5">
                <li>
                    ...
                    <ul class="menu__sub-open">
                        <li>
                            <a href="{{ route('backend.nav') }}" class="menu menu--active">
                                <div class="menu__icon"> <i data-feather="activity"></i> </div>
                                <div class="menu__title">Navigation </div>
                            </a>
                        </li>
                        <li>
                            <a href="" class="menu">
                                <div class="menu__icon"> <i data-feather="activity"></i> </div>
                                <div class="menu__title"> Teachers Info </div>
                            </a>
                        </li>
                        <li>
                ...
                <ul>
                    <li>
                        ...
                        <ul class="side-menu__sub-open">
                            <li>
                                <a href="{{ route('backend.nav') }}" class="side-menu side-menu--active side-menu--open">
                                    <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
                                    <div class="side-menu__title"> Navigation </div>
                                </a>
                            </li>
                            <li>
                                <a href="" class="side-menu">
                                    <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
                                    <div class="side-menu__title"> Teachers Info </div>
                                </a>
                            </li>
                            <li>
